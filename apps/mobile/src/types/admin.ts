/**
 * Mirrors services/api's RoutesController/HaltsController/BusesController and their
 * DTOs/services (services/api/src/routes/*) on origin/feat/backend. All mutation endpoints
 * here are @Roles('ADMIN'); GET endpoints are @Roles('ADMIN', 'CONDUCTOR').
 *
